...
namespace Warzywniak.Controllers
{
    public class AdressesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AdressId,RoadName,HouseNumber,UserId")] Adress adress)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AdressId,RoadName,HouseNumber,UserId")] Adress adress)
        {
            if (ModelState.IsValid)
            {
