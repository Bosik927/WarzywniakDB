...
namespace Warzywniak.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,UserId,OrdareDate")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,UserId,OrdareDate")] Order order)
        {
            if (ModelState.IsValid)
            {
